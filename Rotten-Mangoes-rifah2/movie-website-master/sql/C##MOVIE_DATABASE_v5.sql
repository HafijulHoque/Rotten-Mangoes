...
-- Records of Actor
-- ----------------------------
INSERT INTO "C##MOVIE_DATABASE"."Actor" VALUES ('01', 'John David Washington', TO_DATE('1984-07-28 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), 'John David Washington is an American actor, producer, and former professional football player. He played college football at Morehouse College and signed with the St. Louis Rams as an undrafted free agent in 2006.', '/img/actorpic/john.jpg', '25');
INSERT INTO "C##MOVIE_DATABASE"."Actor" VALUES ('02', 'Matthew Perry', TO_DATE('1969-08-19 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), 'Matthew Langford Perry is an American-Canadian actor, comedian, and producer. He is best known for his role as Chandler Bing on the NBC television sitcom Friends, which ran from 1994 to 2004.', '/img/actorpic/perry.jpg', '80');
INSERT INTO "C##MOVIE_DATABASE"."Actor" VALUES ('03', 'Simone Ashley', TO_DATE('1995-03-30 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), 'Simone Ashwini Pillai, known professionally as Simone Ashley, is a British actress. She is known for her breakout role in the Netflix period drama Bridgerton.', '/img/actorpic/ash.jpg', '10');
INSERT INTO "C##MOVIE_DATABASE"."Actor" VALUES ('04', 'Bryan Cranston', TO_DATE('1956-03-07 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), 'Bryan Lee Cranston is an American actor and filmmaker. He is best known for portraying Walter White in the AMC crime drama series Breaking Bad and Hal in the Fox sitcom Malcolm in the Middle.', '/img/actorpic/bryan.jpg', '13');
INSERT INTO "C##MOVIE_DATABASE"."Actor" VALUES ('05', 'Millie Bobby Brown', TO_DATE('2004-02-19 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), 'Millie Bobby Brown is a British actress, model, and producer. She gained recognition for playing Eleven in the Netflix science fiction series Stranger Things.', '/img/actorpic/brown.jpg', '36');
...
-- Records of Award
-- ----------------------------
INSERT INTO "C##MOVIE_DATABASE"."Award" VALUES ('Oscar', 'USA', 'Each January, the entertainment community and film fans around the world turn their attention to the Academy Awards. Hundreds of millions of movie lovers tune in to watch the glamorous ceremony and learn who will receive the highest honors in filmmaking.', '/img/awards/oscar.png');
INSERT INTO "C##MOVIE_DATABASE"."Award" VALUES ('BAFTA Film Awards', 'UK', 'The British Academy Film Awards, more commonly known as the BAFTA Film Awards is an annual award show hosted by the British Academy of Film and Television Arts to honour the best British and international contributions to film.', '/img/awards/bafta.jpg');
INSERT INTO "C##MOVIE_DATABASE"."Award" VALUES ('Golden Globe Awards', 'USA', 'The Golden Globe Awards are accolades bestowed by the Hollywood Foreign Press Association beginning in January 1944, recognizing excellence in both American and international film and television. Beginning in 2022, there are 105 members of the HFPA.', '/img/awards/goldenglobe.jpg');
INSERT INTO "C##MOVIE_DATABASE"."Award" VALUES ('British Independent Film Awards ', 'UK', 'The British Independent Film Awards is an organisation that celebrates, supports and promotes British independent cinema and filmmaking talent in UK. The ceremony takes place in early December.', '/img/awards/independent.jpg');
...
CREATE TABLE "C##MOVIE_DATABASE"."Directors" (
  ...
  "Description" VARCHAR2(255 BYTE) VISIBLE,
  "Picture" VARCHAR2(255 BYTE) VISIBLE,
  "Notable_work" VARCHAR2(255 BYTE) VISIBLE
)
LOGGING
NOCOMPRESS
PCTFREE 10
...
-- ----------------------------
INSERT INTO "C##MOVIE_DATABASE"."Directors" VALUES ('012', TO_DATE('1970-07-30 04:26:26', 'SYYYY-MM-DD HH24:MI:SS'), 'Christopher Nolan', 'Christopher Nolan CBE is a British-American film director, producer, and screenwriter. His films have grossed more than US$5 billion worldwide and have garnered 11 Academy Awards from 36 nominations.', '/img/directorpic/nolan.jpg', 'Interstellar');
INSERT INTO "C##MOVIE_DATABASE"."Directors" VALUES ('013', TO_DATE('2022-08-15 12:49:50', 'SYYYY-MM-DD HH24:MI:SS'), 'Alfonso Cuarón', 'Alfonso Cuarón Orozco is a Mexican filmmaker. He is known for directing films in a variety of genres including the family drama A Little Princess, the romantic drama Great Expectations.', '/img/directorpic/alfonso.jpg', 'Gravity');
INSERT INTO "C##MOVIE_DATABASE"."Directors" VALUES ('014', TO_DATE('1965-08-13 03:05:12', 'SYYYY-MM-DD HH24:MI:SS'), 'David Crane', 'David Crane (born August 13, 1957) is an American writer and producer. He is best known as one of the co-creators of the television sitcoms Friends and Episodes.', '/img/directorpic/david.jpg', 'Friends');
INSERT INTO "C##MOVIE_DATABASE"."Directors" VALUES ('015', TO_DATE('1976-03-22 03:13:14', 'SYYYY-MM-DD HH24:MI:SS'), 'Reese Witherspoon', 'Laura Jeanne Reese Witherspoon is an American actress and producer. She is the recipient of various accolades, including an Academy Award, a British Academy Film Award, a Primetime Emmy Award, and two Golden Globe Awards.', '/img/directorpic/reese.jpg', 'Gone Girl');
INSERT INTO "C##MOVIE_DATABASE"."Directors" VALUES ('011', TO_DATE('1939-05-08 11:44:55', 'SYYYY-MM-DD HH24:MI:SS'), 'Francis Ford Coppola', 'Francis Ford Coppola is an American film director, producer, and screenwriter. He is considered one of the major figures of the New Hollywood filmmaking movement of the 1960s and 1970s. Coppola is the recipient of six Golden Globe Awards.', '/img/directorpic/ford.jpg', 'The Godfather');
...
INSERT INTO "C##MOVIE_DATABASE"."Merch_order" VALUES ('rifah', '1', '250', '1');
INSERT INTO "C##MOVIE_DATABASE"."Merch_order" VALUES ('rifah', '4', '330', '1');
INSERT INTO "C##MOVIE_DATABASE"."Merch_order" VALUES ('rifah', '4', '330', '1');
INSERT INTO "C##MOVIE_DATABASE"."Merch_order" VALUES ('rifah', '4', '330', '1');
INSERT INTO "C##MOVIE_DATABASE"."Merch_order" VALUES ('rifah', '15', '1260', '1');
INSERT INTO "C##MOVIE_DATABASE"."Merch_order" VALUES ('rifah', '4', '330', '1');
INSERT INTO "C##MOVIE_DATABASE"."Merch_order" VALUES ('rifah', '15', '1260', '1');
...
-- ----------------------------
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('12', 'Eleven Action Figure (Limited Edition)', '450', '/img/Merchandise/Figurines/st.jpg', '100');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('13', 'The Boat', '780', '/img/Merchandise/Figurines/pi.jpg', '400');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('14', 'Tenet Action Figure', '340', '/img/Merchandise/Figurines/tenet.jpg', '100');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('15', 'Walter White Collectible Figure', '1260', '/img/Merchandise/Figurines/bb.jpg', '218');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('3', 'Friends ', '180', '/img/Merchandise/Tshirts/friends.jpg', '97');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('4', 'Elle Woods (Limited Edition)', '330', '/img/Merchandise/Tshirts/legally.jpg', '196');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('5', 'Gravity ', '220', '/img/Merchandise/Tshirts/gravity.jpg', '95');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('1', 'Godfather (Limited Edition)', '250', '/img/Merchandise/Tshirts/godfather.jpeg', '93');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('2', 'Tenet Slim Tee', '300', '/img/Merchandise/Tshirts/tenet.jpg', '198');
INSERT INTO "C##MOVIE_DATABASE"."Merchandise" VALUES ('11', 'Monica Funko Pop', '570', '/img/Merchandise/Figurines/friends_monica.jpg', '100');
...
INSERT INTO "C##MOVIE_DATABASE"."Movies" VALUES ('Legally Blonde', TO_DATE('2001-07-13 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '96', '141.8', 'Comedy', '6');
INSERT INTO "C##MOVIE_DATABASE"."Movies" VALUES ('Life of Pi', TO_DATE('2012-11-21 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '127', '609', 'Adventure', '7');
INSERT INTO "C##MOVIE_DATABASE"."Movies" VALUES ('Saving Private Ryan', TO_DATE('1998-07-21 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '170', '485', 'War', '8');
INSERT INTO "C##MOVIE_DATABASE"."Movies" VALUES ('Schindler''s List', TO_DATE('1994-02-04 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '195', '322.2', 'War', '9');
INSERT INTO "C##MOVIE_DATABASE"."Movies" VALUES ('It''s a Wonderful Life', TO_DATE('1947-01-07 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '130', '3.18', 'Comedy', '10');
...
-- Records of Rated
-- ----------------------------
INSERT INTO "C##MOVIE_DATABASE"."Rated" VALUES ('rifah', '4', '7', 'What a tiger');
...
-- Records of Show
-- ----------------------------
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Tenet', 'Sci-fi', 'When a few objects that can be manipulated and used as weapons in the future fall into the wrong hands, a CIA operative, known as the Protagonist, must save the world.', TO_DATE('2020-08-12 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/tenet.jpg', '012', 'Syncopy', '2', 'https://www.youtube.com/watch?v=LdOM0x0XDMo');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Gravity', 'Sci-fi', 'On an outer space mission, Dr Ryan Stone, an engineer, and Matt Kowalski, an astronaut, are hit by high-speed space debris. As the situation gets dire, Stone, the lone survivor, rises to the occasion.', TO_DATE('2014-01-01 12:51:11', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/gravity.jpg', '013', 'Warner Bros. Pictures', '3', 'https://www.youtube.com/watch?v=ufsrgE0BYf0');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Friends', 'Sitcom', 'Follow the lives of six reckless adults living in Manhattan, as they indulge in adventures which make their lives both troublesome and happening.', TO_DATE('1994-08-15 13:13:57', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/friends.jpg', '014', 'Warner Bros. Pictures', '11', 'https://www.youtube.com/watch?v=IEEbUzffzrk');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Brooklyn Nine-Nine', 'Sitcom', 'Ray Holt, an eccentric commanding officer, and his diverse and quirky team of odd detectives solve crimes in Brooklyn, New York City.', TO_DATE('2017-03-15 16:16:25', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/b99.jpg', '013', 'Paramount Pictures', '12', 'https://www.youtube.com/watch?v=q6G_RMGk3vs');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Bridgerton', 'Romance', 'During the Regency era in England, eight close-knit siblings of the powerful Bridgerton family attempt to find love.', TO_DATE('2020-06-26 03:11:04', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/bridgerton.jpg', '015', 'Pixar', '13', 'https://www.youtube.com/watch?v=gpv7ayf_tyE');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Breaking Bad', 'Drama', 'Walter White, a chemistry teacher, discovers that he has cancer and decides to get into the meth-making business to repay his medical debts. His priorities begin to change when he partners with Jesse.', TO_DATE('2008-03-12 03:16:14', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/breakingbad.jpg', '015', 'Syncopy', '14', 'https://www.youtube.com/watch?v=HhesaQXLuRY');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Roman Holiday', 'Romance', 'Stuck with boredom in her luxurious confinement, a princess escapes from her guardians and falls in love with an American news reporter in Rome.', TO_DATE('1953-02-19 03:18:09', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/roman.jpg', '015', 'Warner Bros. Pictures', '4', 'https://www.youtube.com/watch?v=ELb4S8P3q20');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Romeo + Juliet', 'Tragedy', 'The rivalry between Verona''s two well-established families, the Capulets and the Montagues, affects the relationship of their children Romeo and Juliet.', TO_DATE('1996-08-26 03:23:44', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/romeo.jpg', '011', 'Pixar', '5', 'https://www.youtube.com/watch?v=4VBsi0VxiLg');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Stranger Things', 'Mystery', 'When a little boy vanishes, a small town uncovers a mystery involving secret experiments, terrifying supernatural forces, and one strange little girl.', TO_DATE('2016-05-31 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/strangerthings.jpg', '014', 'Paramount Pictures', '15', 'https://www.youtube.com/watch?v=b9EkMc79ZSU');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Life of Pi', 'Adventure', 'Pi Patel finds a way to survive in a lifeboat that is adrift in the middle of nowhere. His fight against the odds is heightened by the company of a hyena and a male Bengal tiger.', TO_DATE('2012-11-21 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/pi.jpg', '012', 'Disney', '7', 'https://www.youtube.com/watch?v=71_N53VI0fA');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Saving Private Ryan', 'War', 'During the Normandy invasion of World War II, Captain John Miller is assigned the task of searching for Private James Ryan, whose three brothers have already been killed in the war.', TO_DATE('1998-07-21 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/ryan.jpg', '012', 'Paramount Pictures', '8', 'https://www.youtube.com/watch?v=9CiW_DgxCnQ');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Schindler''s List', 'War', 'Oskar Schindler, a German industrialist and member of the Nazi party, tries to save his Jewish employees after witnessing the persecution of Jews in Poland.', TO_DATE('1994-02-04 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/schindler.jpg', '013', 'Syncopy', '9', 'https://www.youtube.com/watch?v=mxphAlJID9U');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('It''s a Wonderful Life', 'Comedy', 'When a frustrated businessman, George Bailey, becomes suicidal, an angel from heaven, Clarence, is sent to him. To his change of heart, she shows him what life would have been without his existence.', TO_DATE('1947-01-07 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/wonderful.jpg', '014', 'Paramount Pictures', '10', 'https://www.youtube.com/watch?v=iLR3gZrU2Xo');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Love, Victor', 'Drama', 'The first season focuses on a new student at Creekwood High School, Victor. The series follows his journey of self-discovery: facing challenges at home and struggling with his sexual orientation.', TO_DATE('2020-06-17 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/victor.jpg', '015', 'Disney', '16', 'https://www.youtube.com/watch?v=7S_hn6wJ0g4');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Magnum, P.I.', 'Police', 'This series makes the most of its Hawaiian setting by sending private eye Thomas Magnum all over Oahu righting wrongs.', TO_DATE('1980-12-11 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/magnum.jpg', '012', 'Pixar', '17', 'https://www.youtube.com/watch?v=LBIgXhiOpeQ');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('The Vampire Diaries', 'Horror', 'On her first day at high school, Elena meets Stefan and immediately feels a connection with him. However, what she does not know is that Stefan and his brother, Damon, are in fact vampires.', TO_DATE('2009-09-10 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/vampire.jpg', '011', 'Warner Bros. Pictures', '18', 'https://www.youtube.com/watch?v=Aw5nkIN4pAU');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('The Good Place', 'Comedy', 'Eleanor, a deceased saleswoman who lived a morally corrupt life, finds herself in a heaven-like afterlife in a case of mistaken identity and tries to hide her past in order to stay there.', TO_DATE('2016-09-19 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/goodplace.jpg', '013', 'Warner Bros. Pictures', '19', 'https://www.youtube.com/watch?v=29iKAAeRvI4');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('The Umbrella Academy', 'Action', 'The Umbrella Academy is an American superhero streaming television series based on the comic book series of the same name written by Gerard Way, illustrated by Gabriel Bá, and published by Dark Horse Comics.', TO_DATE('2019-02-15 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/tvshows/umbrella.jpg', '011', 'Paramount Pictures', '20', 'https://www.youtube.com/watch?v=0DAmWHxeoKw');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('Legally Blonde', 'Comedy', 'Elle''s boyfriend breaks up with her for a smarter girl as he plans to become a politician and joins Harward law school. Elle gets enrolled in the same school in an effort to teach him a lesson.', TO_DATE('2001-07-13 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/legally.jpg', '015', 'Syncopy', '6', 'https://www.youtube.com/watch?v=vWOHwI_FgAo');
INSERT INTO "C##MOVIE_DATABASE"."Show" VALUES ('The Godfather', 'Crime', 'Don Vito Corleone, head of a mafia family, decides to hand over his empire to his youngest son Michael. However, his decision unintentionally puts the lives of his loved ones in grave danger.', TO_DATE('1972-03-24 11:45:54', 'SYYYY-MM-DD HH24:MI:SS'), '/img/movies/godfather.jpg', '011', 'Paramount Pictures', '1', 'https://www.youtube.com/watch?v=UaVTIH8mujA');
...
INSERT INTO "C##MOVIE_DATABASE"."Tv_series" VALUES ('Love, Victor', TO_DATE('2020-06-17 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '3', '50', 'Drama', '16');
INSERT INTO "C##MOVIE_DATABASE"."Tv_series" VALUES ('Magnum, P.I.', TO_DATE('1980-12-11 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '8', '108', 'Police', '17');
INSERT INTO "C##MOVIE_DATABASE"."Tv_series" VALUES ('The Vampire Diaries', TO_DATE('2009-09-10 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '8', '130', 'Horror', '18');
INSERT INTO "C##MOVIE_DATABASE"."Tv_series" VALUES ('The Good Place', TO_DATE('2016-09-19 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '4', '52', 'Comedy', '19');
INSERT INTO "C##MOVIE_DATABASE"."Tv_series" VALUES ('The Umbrella Academy', TO_DATE('2019-02-15 00:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '3', '22', 'Action', '20');
...
-- ----------------------------
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('nabid', '124', 'nabid', 'hasan', TO_DATE('2022-08-10 13:53:59', 'SYYYY-MM-DD HH24:MI:SS'), 'nabid.hasan987@gmail.com', '111', 'www', NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('rafiq', '$2b$04$CGwnEes5YmAp5sW3NGlf6OQlO6I8ke3xmF/jPHhDqOWFyYwFp3BW2', 'Rafiqul', 'Alam', NULL, 'rafiq@gmail.com', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('Siam', 'cheggstudy7869@gmail.com', NULL, NULL, NULL, '$2b$04$iPrvN/Mo.VkBupc1zGRPxOaAoOQeR/QRqT08gplgRt7ajpZf.xmH2', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('Amychan0305', 'araminafairy@gmail.com', NULL, NULL, NULL, '$2b$04$SW/nRFb8Un6lcj9CTREQru5wObDboLkILnggSZ5HprP66juRcthcO', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('AVA12', 'tasfia.neha1@gmail.com', NULL, NULL, NULL, '$2b$04$AldOTTG27v2u0Z7Al/MsZeg6kbsMEGw4A/SSVCYWic3m/IY7SPjFm', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('nafis', 'tasfia.nehava@gmail.com', NULL, NULL, NULL, '$2b$04$Je1CEOVvL47dL.IUf1sa4.DT0sa7f99JC.Ekgo2iW74KInoxfig4.', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('LMS', 'tasfia.nehaLMS@gmail.com', NULL, NULL, NULL, '$2b$04$JdXKkz1a.GdfkNJkoh8Jc..zcY.d/kkINvXMxoDXkdyCpv4gCX4Tu', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('neha', 'tasfia.nehanabis@gmail.com', NULL, NULL, NULL, '$2b$04$oZENER68Qdvl/Z1Z.V/5wuBmsrfEoMBX3x9pKP0mtPDTiRv8fpH0W', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('nahin', '$2b$04$ktSN2pKCHD5Ndp8LoW5rw.7S3K6OLZ6pKGJJGRFMmtKB6peXphuQG', NULL, NULL, NULL, '190501339@ugrad.cse.buet.ac.bd', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('ABC', '$2b$04$cMbwCBPId6jOXbE/eCxogOY44jJodotXhcSXZ2N0KGjQ0ZXGYWv/S', NULL, NULL, NULL, 'ABC123@gmail.com', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('sami', '$2b$04$fk3z36zK7qjMbaOPOOqj9epJ6up.h.gCH37GgQqZ5M.nT7tRPXSVm', NULL, NULL, NULL, 'sami@gmail.com', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('rifah', '$2b$04$unvDDpV7vw.gFXuPCd6x/.MugYjUAP0y8mUkuA.6yRxnPda.I9LdS', 'Mia', 'Khalifa', NULL, 'tasfia.neha0305@gmail.com', '56478', NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('hay', '$2b$04$.fKiSVgRrM9GtoVF6Vqvyuv.OtYUA8z/ZIKmOXxK2lp5pMbYLtd5i', NULL, NULL, NULL, 'xyz@gmail.com', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('lamia', '$2b$04$mvfLkfMq1vwX8dngwV3cJ.7OprSV.xhDUGcwLdVfcToh3qDX/sGVe', NULL, NULL, NULL, 'lamia@yahoo.com', NULL, NULL, NULL);
INSERT INTO "C##MOVIE_DATABASE"."Useraccount" VALUES ('rifah1', '$2b$04$LguAbV.VD/uJ7G3Kr97m.uPFUjsXngM0s6fSnxHUfE9xS73iYOMVS', NULL, NULL, NULL, 'abcd@gmail.com', NULL, NULL, NULL);
